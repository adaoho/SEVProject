  ...
  return (
    <>
      <div className="bg-samitra-800">
        {/* Desktop View */}
        <div className="hidden lg:flex w-full items-center justify-center h-screen">
        ...
        {/* Phone View */}
        <div className="flex flex-col lg:hidden w-screen items-center justify-center h-[50rem] relative">
